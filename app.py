...
def inicio():
    ...
    <body style="margin:0; background:#f4f4f4; font-family:Arial; text-align:center;">
        ...
        <div style="padding:50px;">
            ...
            <a href="/admin" style="display:block; mar⁸gin:20px auto; width:220px; height:70px; background:red; color:white; text-align:center; line-height:70px; font-weight:bold; text-decoration:none; border-radius:15px; font-size:18px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); z-index:99999;">ENTRAR AL PANEL</a>
