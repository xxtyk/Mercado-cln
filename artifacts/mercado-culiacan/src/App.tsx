  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", backgroundColor: "#f5f5f5", fontFamily: "Roboto, sans-serif" }}>
      <header style={{
        ...
        <button
          onClick={() => { setCarritoAbierto(true); setPedidoConfirmado(false); }}
          style={{
        ...
        >
          ...
          >
            <div style={{
              ...
              <span style={{ fontSize: "18px", fontWeight: 500 }}>🛒 Mi Carrito</span>
              <button
                onClick={() => setCarritoAbierto(false)}
                ...
                <>
                  {carrito.map((item) => (
                    <div key={item.producto.id} style={{
                      ...
                      />
                      <div style={{ flex: 1 }}>
                        <p style={{ fontSize: "14px", fontWeight: 600, color: "#212121", marginBottom: "4px" }}>
                          {item.producto.nombre}
                        </p>
                        <p style={{ fontSize: "13px", color: "#1976d2", fontWeight: 600 }}>
                          ${item.producto.precio}.00
                        </p>
                      </div>
                  ...
                  <div style={{ marginTop: "16px", backgroundColor: "#e8f5e9", borderRadius: "8px", padding: "14px 16px" }}>
                    <p style={{ fontSize: "13px", fontWeight: 600, color: "#2e7d32", marginBottom: "2px" }}>
                      💵 Método de pago
                    </p>
            ...
            {!pedidoConfirmado && carrito.length > 0 && (
              <div style={{ padding: "16px", borderTop: "1px solid #e0e0e0" }}>
                ...
                >
                  Confirmar pedido · ${totalFinal}.00
                </button>
              </div>
            )}
          </div>
